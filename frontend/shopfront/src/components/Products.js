...
function Products({ filterText, products, cart, name, page, totalPages, handleFilterTextChange, handlePageChange, handleSettings, handleLogout, handleAddToCart, handleShowDetails, handleSaveProceed, handleResetCart, handlePreviousOrders, handleBack }) {
  return (
    <div className="main">
      <br/>
